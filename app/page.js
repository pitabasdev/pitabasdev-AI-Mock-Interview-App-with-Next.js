    ...
    <div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          >
            ...
            <span className="text-sm font-medium">
              Infotactsolution.tech All new Apps
            </span>
            <svg
            ...
            {[
              {
                ...
                cost: 0,
                offering: [
                  "✔️ Create 3 Free Mock Interview",
                  "✔️ Unlimited Retake Interview",
                  "❌ Practice Question",
                  "❌ Tubeguruji.Com Exclusive App Access",
                  "❌ Email Support",
                ],
              },
              {
                ...
                offering: [
                  ...
                  "✔️ Unlimited Retake Interview",
                  "✔️ Practice Question",
                  "✔️ infotactsolution.tech Exclusive App Access",
                  "✔️ Email Support",
                ],
              },
              {
                ...
                name: "Yearly",
                cost: 79.99,
                paymentLink: "https://buy.stripe.com/test_6oE7Jhd9TgfT1yY4gh",
                offering: [
                  "✔️ Create Unlimited Mock Interviews",
                  "✔️ Unlimited Retake Interview",
                  "✔️ Practice Question",
                  "✔️ infotactsolution.tech Exclusive App Access",
              ...
              <div
                key={plan.id}
                className="flex flex-col items-center justify-center rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12"
              >
                ...
                <a
                  ...
                  className="mt-8 w-full rounded-full border border-indigo-600 bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring focus:ring-indigo-300"
                >
                  Get Started
                </a>
              </div>
      ...
      <footer className="py-6 bg-gray-100 text-center text-gray-600">
        <div className="container mx-auto">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Mock Interview Platform. All
            Rights Reserved.
          </p>
          <div className="mt-2">
            <a
              href="/privacy-policy"
              className="text-pink-600 hover:underline mx-2"
            >
              Privacy Policy
            </a>
            <a href="/terms" className="text-pink-600 hover:underline mx-2">
              Terms of Service
            </a>
            <a href="/contact" className="text-pink-600 hover:underline mx-2">
              Contact Us
            </a>
          </div>
        </div>
